...
#+date: 2018-03-14; Revision Time-stamp: <2021-06-09 09:47:44 jbatke>
...
Parts of booast:
- [[file:acoustics.org]] implements acoustical stuff (plane waves,
  spherical waves);
  
- file:microphones.org simulates microphones;
  
- file:ambisonics.org provides tools for simulation of Higher Order Ambisonics.

** Usage

The toolbox is entirely implemented using org-mode from emacs (see [[Installation]]).  It makes use of the babel functions, i.e. the ingest of [[file:octavetemplates.org]] is necessary. For the time being, [[file:booast.setup]] does the not automatically.
